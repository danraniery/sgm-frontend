...
import {API_SERVICES_URL, API_USERS_URL, DISABLE_GENERIC_ROUTE} from '../../app.constants';
...
export class SgmServiceService implements IService<ISGMService> {
    ...
    getAll(params: any): Observable<HttpResponse<ISGMService[]>> {
        const options = createRequestOption(params);
        return this.http.get<ISGMService[]>(`${API_USERS_URL}`, {params: options, observe: 'response'});
    }
